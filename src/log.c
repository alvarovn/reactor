...
void l_notice(const char *format, ...){
    va_list args;
...
void l_notice_e(const char *format, ...){
    va_list args;

    va_start(args, format);
    rlog_e(LOG_NOTICE, format, args);
    va_end(args);
}

void l_warning(const char *format, ...){
    va_list args;
...
void l_warning_e(const char *format, ...){
    va_list args;

    va_start(args, format);
    rlog_e(LOG_WARNING, format, args);
    va_end(args);
}
...
void l_error_e(const char *format, ...){
    va_list args;

    va_start(args, format);
    rlog_e(LOG_ERR, format, args);
    va_end(args);
}
